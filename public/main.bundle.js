...
var appRoutes = [
    ...
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_10__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthenticationGuard */]] },
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_9__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthenticationGuard */]] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthenticationGuard */]],
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(valService, flashMsg, authService, router) {
    ...
    LoginComponent.prototype.submitForm = function (loginForm) {
        var _this = this;
        this.authService.authenticateUser(loginForm).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeUserData(data.token, data.user);
                _this.flashMsg.show('You are logged in', { cssClass: 'alert-success', timeout: 3000 });
...
module.exports = "<!-- <header> -->\n  <!-- Fixed navbar -->\n  <nav class=\"navbar navbar-expand-md navbar-dark fixed-top bg-dark\">\n    <a class=\"navbar-brand\"routerLink='/home'>MEAN App</a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarCollapse\" aria-controls=\"navbarCollapse\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">\n      <ul class=\"navbar-nav navbar-left\">\n        <li class=\"nav-item\" [routerLinkActive]=\"['active']\">\n          <a class=\"nav-link\" routerLink='/home'>Home <span class=\"sr-only\">(current)</span></a>\n        </li>\n        <li *ngIf=\"authService.isLoggedIn()==true\" class=\"nav-item\" [routerLinkActive]=\"['active']\">\n          <a class=\"nav-link\" routerLink=\"/profile\">Profile</a>\n        </li>\n        <li *ngIf=\"authService.isLoggedIn()==true\" class=\"nav-item\" [routerLinkActive]=\"['active']\">\n          <a class=\"nav-link\" routerLink=\"/dashboard\">Dashboard</a>\n        </li>\n        <li *ngIf=\"authService.isLoggedIn()==false\" class=\"nav-item\" [routerLinkActive]=\"['active']\">\n            <a class=\"nav-link\" routerLink=\"/login\">Login</a>\n        </li>\n        <li *ngIf=\"authService.isLoggedIn()==false\" class=\"nav-item\" [routerLinkActive]=\"['active']\">\n            <a class=\"nav-link\" routerLink=\"/register\">Register</a>\n        </li>\n        <li *ngIf=\"authService.isLoggedIn()==true\" class=\"nav-item\">\n            <a class=\"nav-link\" (click)='onLogOut()' href=\"#\">Logout</a>\n          </li>\n      </ul>     \n      <!-- <form class=\"form-inline mt-2 mt-md-0\">\n        <input class=\"form-control mr-sm-2\" type=\"text\" placeholder=\"Search\" aria-label=\"Search\">\n        <button class=\"btn btn-outline-success my-2 my-sm-0\" type=\"submit\">Search</button>\n      </form> -->\n    </div>\n  </nav>\n<!-- </header> -->\n\n"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(valService, flashMsg, authService, router) {
        this.valService = valService;
        this.flashMsg = flashMsg;
        this.authService = authService;
        this.router = router;
...
module.exports = "<form #registerForm=\"ngForm\" (submit)=\"submitForm(registerForm.value)\">\n    <div class=\"form-group\">\n      <label>Name</label>\n      <input type=\"text\" class=\"form-control\" name=\"name\" [(ngModel)]=\"name\"  placeholder=\"Name\" required>      \n    </div>\n    <div class=\"form-group\">\n      <label>Username</label>\n      <input type=\"text\" class=\"form-control\" name=\"username\" [(ngModel)]=\"username\" placeholder=\"Username\" required>\n    </div>\n    <div class=\"form-group\">\n        <label>Email</label>\n        <input type=\"email\" class=\"form-control\" name=\"email\" [(ngModel)]=\"email\" placeholder=\"Email\" required>\n      </div>\n    <div class=\"form-group\">\n      <label>Password</label>\n      <input type=\"password\" class=\"form-control\" name=\"password\" [(ngModel)]=\"password\" placeholder=\"Password\" required>\n    </div>\n    <button [disabled]=\"!registerForm.valid\" type=\"submit\" class=\"btn btn-primary\">Submit</button>\n  </form>"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(valService, flashMsg, authService, router) {
        this.valService = valService;
        this.flashMsg = flashMsg;
        this.authService = authService;
        this.router = router;
    ...
    RegisterComponent.prototype.submitForm = function (registerForm) {
    ...
    RegisterComponent.prototype.registerUser = function (user) {
        var _this = this;
        this.authService.registerUser(user).subscribe(function (resultData) {
            debugger;
            if (resultData.success) {
                _this.flashMsg.show('You are Registred', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMsg.show('' + resultData.msg, { cssClass: 'alert-danger', timeout: 3000 });
...
module.exports = "<section class=\"jumbotron text-center\">\n    <div class=\"container\">\n      <h1 class=\"jumbotron-heading\">MEAN Authentication App</h1>\n      <p class=\"lead text-muted\">This is a demo of MEAN Authentication App with Complex MongoDB Model<p>\n        <a href=\"#\" class=\"btn btn-primary my-2\" [routerLinkActive]=\"['active']\" routerLink='/register'>Register</a>\n        <a href=\"#\" class=\"btn btn-secondary my-2\" [routerLinkActive]=\"['active']\" routerLink='/login'>Login</a>\n      </p>\n    </div>\n  </section>"
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.getValidStatus = function () {
        debugger;
